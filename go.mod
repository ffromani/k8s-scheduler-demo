module github.com/ffromani/k8s-scheduler-demo
...
require (
	...
	sigs.k8s.io/scheduler-plugins v0.27.8
)
...
require (
	...
	k8s.io/kube-scheduler v0.27.8 // indirect
...
replace (
	...
	k8s.io/kubernetes => k8s.io/kubernetes v1.27.7
